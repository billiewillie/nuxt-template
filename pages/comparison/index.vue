      ...
      <div class="container">
        ...
        <div class="flex flex-wrap gap-2">
          <ClientOnly>
            <Button
              :variant="
                activeCategory.id === category.id ? 'secondary' : 'outline'
              "
              v-for="category in categories"
              :key="category.id"
              class="rounded-full text-sm p-2 h-8 md:h-10 border"
              @click="
              ...
              <TableHeader>
                <TableRow class="!border-b-0">
                  <TableHead
                    ...
                    class="p-1"
                    :style="`min-width: ${setColumnWidth(
                      tableWrapperWidth
                    )}px; max-width: ${setColumnWidth(tableWrapperWidth)}px;`"
                    :key="product.id"
                  >
                    <BaseProductCard
                      :product="product"
