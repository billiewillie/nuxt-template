    ...
    <div class="container">
      <div class="flex flex-col gap-4">
        <Card
          ...
          <CardContent class="flex flex-col xl:flex-row w-full p-0">
            <NuxtPicture
              src="/img/items/item-1.jpg"
              class="flex basis-1/3 object-contain object-center justify-center"
              alt="alt" />
            <div class="basis-2/3 flex flex-col items-start gap-6">
              <h2>Автоматический разливочный модуль в чашки Петри</h2>
              <Separator />
